...
| `button(buf, x, y, label, theme)` | coords, texto | `u16` ancho | botón teal 1 fila, padding 2 por lado (`  TEXTO  `, mín. 10); sombra solo inferior `(x_start+1..=x_end, y+1)`, mezcla (glifo intacto, `bg` negro + `dim`) |
